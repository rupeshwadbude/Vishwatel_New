...
import { actionFormatter, Breadcrumb, DataTable,ListingHeader,PageHeader, SweetAlert, switchFormatter } from "../../../../components";
...
function UserManagement() {
  ...
  const onTypeDeleteConfirmAlert = () =>{
    modalNotification({ type: "success", message: "User Deleted Successfully", })
  ...
  const options = () => {
    const optionsArr = [
      ...
      },
      {
        ...
        action: "confirm",
        onClickHandle: () => {setIsAlertVisibleDelete(true); document.body.click()},
      },
