...
import { Input as TextInput, ModalComponent, PageHeader,
   Select
   } from "../../../components";
              ...
              <div className="telePage_inner text-center">
                <div className="position-relative">
                  <video width="100%" height="360" controls>
                    ...
                    <track kind="captions" label="English" srcLang="en" src="captions.vtt" />
      ...
      (
              ...
              <div className="telePage_cnt">
                ...
                <div className="telePage_inner telePage_inner-full">
                  ...
                  <p className="numberInfo">
                    Anyone can buy a phone number in india.<br/> Phone numbers in india are not available for free with paid plans cannot be used for free on your website.
                  </p>
                  ...
                  <table className="table">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <div className="d-flex align-items-center" onClick={() => setSubscription(true)}>
                            <img src="/assets/images/admin/bharat-flag.png" className="img-fluid" alt="bharat-flag"/>
                            +91-8310-771100
                          </div>
                        </td>
                        <td>-</td>
        ...
        <div className="getNumberModal_inner">
          ...
          <ul className="getNumberModal_list list-unstyled ps-0">
            <li>
              <div className="d-flex align-items-center">
                <img src='/assets/images/admin/flag-of-Albania.png' className="img-fluid" alt="flag-of-Albania"/>
                <span>Albania</span>
              </div>
            </li>
            <li>
              <div className="d-flex align-items-center">
                <img src='/assets/images/admin/flag-of-Argentina.png' className="img-fluid" alt="flag-of-Argentina"/>
                <span>Argentina</span>
              </div>
            </li>
            <li>
              <div className="d-flex align-items-center">
                <img src='/assets/images/admin/flag-of-Australia.png' className="img-fluid" alt="flag-of-Australia"/>
                <span>Australia</span>
              </div>
            </li>
            <li>
              <div className="d-flex align-items-center">
                <img src='/assets/images/admin/flag-of-Austria.png' className="img-fluid" alt="flag-of-Austria"/>
                <span>Austria</span>
              </div>
            </li>
            <li>
              <div className="d-flex align-items-center">
                <img src='/assets/images/admin/flag-of-Belgium.png' className="img-fluid" alt="flag-of-Belgium"/>
                <span>Belgium</span>
              </div>
            </li>
            <li>
              <div className="d-flex align-items-center">
                <img src='/assets/images/admin/flag-of-Bolivia.png' className="img-fluid" alt="flag-of-Bolivia"/>
                <span>Bolivia</span>
              </div>
            </li>
            <li>
              <div className="d-flex align-items-center">
                <img src='/assets/images/admin/flag-of-Bosnia-Herzegovina.png' className="img-fluid" alt="flag-of-Bosnia-Herzegovina"/>
          ...
          <div className="form-group mb-4">
            ...
            <div className="mb-4">
              <div className="d-flex align-items justify-content-between">
                ...
                <span className="d-block">Yearly price is $419.88 you save 5% off yearly subscriptions.</span>
            </div>
            ...
            <div className="mb-4">
              <div className="d-flex align-items justify-content-between">
                ...
                <span className="d-block">You will be requested to provide an address anywhere in the world if you purchase this type of number.</span>
            </div>
            ...
            <div>
              <div className="d-flex align-items justify-content-between">
                ...
                <span className="d-block">
                  Anyone can buy a phone number in india. phone numbers in india are not available for free with paid plans and cannot be used for free on your website.
                </span>
            </div>
            ...
            <div className="text-center mt-4">
              ...
              <Link to="#" className="link-primary d-block">Terms & Conditions</Link>
            </div>
        </div>
      </ModalComponent>
    </>
